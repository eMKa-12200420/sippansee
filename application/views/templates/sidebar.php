    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="index3.html" class="brand-link">
                ...
                <span class="brand-text font-weight-light">SIPPANSE</span>
            </a>
            ...
            <div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
                        <li class="nav-item has-treeview menu-open">
                            <a href="<?= base_url('dasboard/index'); ?>" class="nav-link">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="<?= base_url('jurusan/index'); ?>" class="nav-link">
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="<?= base_url('pendaftar/tambah'); ?>" class="nav-link">
                                <i class="nav-icon fas fa-edit"> </i>
                                <p>
                                    Form Pendaftaran
                                </p>
                        ...
                        <li class="nav-item has-treeview menu-open">
                            <a href="<?= base_url('pendaftar/index'); ?>" class="nav-link">
